...
class MetaTest extends PHPUnit_Framework_TestCase {
	 ...
	 */
	function has() {
		$meta = pixcore::instance('PixcoreMeta', array('preset1' => 'success'));
	 ...
	 */
	function add() {
		$meta = pixcore::instance('PixcoreMeta', array('preset1' => 'success', 'preset2' => array('success')));
	...
	function metadata_array() {
		$meta = pixcore::instance('PixcoreMeta', array('preset1' => 'value1', 'preset2' => 'value2'));
